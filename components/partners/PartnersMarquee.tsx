...
export function PartnersMarquee() {
  ...
  return (
    <div className="relative overflow-hidden py-6 md:py-8 group">
      <div className="flex gap-6 md:gap-14 items-center animate-[marquee-a1_40s_linear_infinite] hover:[animation-play-state:paused] w-max">
        {loop.map((p, i) => (
